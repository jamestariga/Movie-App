...
const Card = (props) => {
  ...
  return (
    <>
      <div
        className='flex justify-center space-x-6 lg:w-auto w-full min-h-[5rem] h-[20rem] rounded-xl shadow-lg md:py-6 md:px-10 py-2 px-6 overflow-hidden'
        style={{
          backgroundImage: `url(${backdrop})`,
          backgroundSize: 'cover',
        }}
      >
        <div className='hidden sm:flex max-w-xs w-2/5 xl:w-2/6 shadow-xl rounded-3xl overflow-hidden'>
          {backdrop_path ? (
